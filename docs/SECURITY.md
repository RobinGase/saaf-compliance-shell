...
| `check deadline validity` | Wrong statutory notification windows | A deadline clause ("within N hours/days", "no later than N hours", Dutch "binnen N uur") is linked to GDPR / NIS2 / DORA and the normalised hour count does not match the framework's statutory set — GDPR Art. 33 {72h}, NIS2 Art. 23 {24h early warning, 72h incident, 1 month final}, DORA Art. 19 + RTS {4h initial, 72h intermediate, 1 month final}. "1 month" is accepted with ±24h tolerance so 28–31-day paraphrases pass. |
